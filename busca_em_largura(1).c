...
void busca_em_largura(grafo_t *grafo, int numVertice){
	/*
	Cores:
...
int main(){
	...
	printf("Informe um valor entre 0 e 4 para gerar a tabela de busca em largura: ");
	scanf("%d", &valor);
	busca_em_largura(dir_grafo, valor);
	return 0;	
}
